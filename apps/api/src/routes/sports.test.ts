        ...
        events: [
          {
            ...
            status: { type: { state: 'pre' as const, completed: false, description: 'Scheduled', shortDetail: '8:00 PM' }, period: 0, displayClock: '' },
            competitions: [],
          },
        ],
      };
        ...
        events: [
          {
            ...
            status: { type: { state: 'in' as const, completed: false, description: 'In Progress', shortDetail: 'Round 2' }, period: 2, displayClock: '' },
            competitions: [],
          },
        ],
      };
